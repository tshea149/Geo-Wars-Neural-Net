    ...
    def on_loop(self):
        ...
        for ava in self.avas:
            ...
            while ava.dead == False:
                ...
                playerCoords = GWR.getPlayerCoords()
                ...
                self.score = GWR.getScore() #Game score here
                self.enemy.enemyList = GWR.getEnemyList() #update enemylist
